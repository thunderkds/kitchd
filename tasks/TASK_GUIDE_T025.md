...
| verify | ☒ pass | pass — live API probes (curl) against a running scratch-port server confirmed signup default, valid update, invalid-value 400, unauthenticated 401 — archived at `reports/evidence/T025/verify-session.md` |
