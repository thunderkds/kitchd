...
|----|-------|--------|---------------|-----------|------|----------|
| T025 | Backend theme-preference (`User.themePreference` enum + endpoint) | Todo | backend-developer | C1 | Low | P1 |
| T026 | Frontend theme system (tokens, Dark Neon, full migration, switcher) | Todo | frontend-developer | C2 | Low | P1 |
