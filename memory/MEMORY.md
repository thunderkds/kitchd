...
- [Web dev server fixed at localhost:8766](decisions.md#2026-07-02--web-dev-server-fixed-at-localhost8766-for-playwright-mcp-evidence-capture) — Playwright MCP targets this port for all FE UI Evidence capture
