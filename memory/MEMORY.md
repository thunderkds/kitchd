...
- [Evidence Gate hook checks root tasks/, not worktree copies](learnings.md#2026-07-03--evidence-gate-hook-pre_bash_block_unsafe_mergepy-checks-the-root-tasks-dir-not-worktree-copies) — copy finished guide to root before merge; label Evidence row exactly `| verify |`
