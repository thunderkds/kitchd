...
- [Evidence Gate "pass" gotcha hit again on T007](learnings.md#2026-07-03--evidence-gate-hook-pre_bash_block_unsafe_mergepy-checks-the-root-tasks-dir-not-worktree-copies-and-requires-pass-in-the-third-cell) — always start the verify row's Notes cell with a standalone `PASS —` prefix, don't rely on the template reminder alone
